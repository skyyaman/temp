...
$.innerKeyWords =
    [
        "幼儿园", "教程", "辅导", "孩子", "小学", "成人用品", "套套", "情趣",
        "自慰", "阳具", "飞机杯", "男士用品", "女士用品",
        "内衣", "高潮", "乳腺", "肛塞","宝宝", "芭比", "娃娃", "男用",
        "女用", "神油", "足力健", "老年", "老人","丝袜", "黑丝", "磨脚",
        "脚皮", "除臭", "性感", "内裤", "跳蛋","肛门","狐臭","少女",
        "安全套", "龟头", "阴道", "阴部","流量","看房","教材","练习","上课",
        "学习","定制","小程序","编程","投资","培训","生殖器",
        "免费","护腰","口腔","避孕","艾条","老太太","妇", 
        "屁股","痔疮","肛","鸡眼","健康","私处","卫生","胸罩","洋娃娃",
        "膏药","软件","美瞳","颈椎","脚气","妈妈","保健", 
        "必读","胶囊","丰胸","档案袋","癣","康复",
        "吊带","网课","网校","课程","三角裤","英语","俄语","四级",
        "六级","在线","宫颈","糜烂","狐","毒","锁骨","黑头","延时",
        "和田玉","益生菌","长高","VIP","主题课",
        "训练营","旅游","教育","体验","活动","赠品","门票"
    ]
...
let args_xh = {
    ...
    */
	remainingDay:process.env.JD_TRY_REMAININGDAY * 1||18
}
